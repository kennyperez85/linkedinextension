...
- If **Scan this page** appears to do nothing, make sure you are on a URL like:
  `https://www.linkedin.com/search/results/people/...`
- If you installed the extension while LinkedIn was already open, refresh that tab once.
- The popup now auto-injects the content script if needed and will show an error message when the tab is unsupported.
